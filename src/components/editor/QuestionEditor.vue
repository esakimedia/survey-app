<template>
    <!-- Question index -->
    <div class="flex items-centr justify-between">
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-3">
            ...
            <select
                ...
                v-model="model.type"
                @change="typeChange"
                class="mt-1 py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border bg-white border-gray-300 rounded-md"
            >
                <option
    ...
    <div class="mt-3 col-span-9">
        ...
        <textarea
            ...
            class="mt-1 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
        ></textarea>
    </div>
    <!-- /Question Description -->
    ...
    <div>
        <div v-if="shouldHaveOptions()" class="mt-2">
            <h4 class="text-sm font-semibold mb-1 justify-between items-center">
                Options
                <!-- Add new option -->
                <button
                    type="button"
            ...
            >You don't have any options defined</div>
            ...
            >
                ...
                <button
                    ...
                    class="border border-transparent text-red-500 hover:border-red-600"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-6 w-6"
